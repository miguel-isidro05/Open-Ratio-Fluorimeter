...
class CountMeasurementScreen:
    ...
    def __init__(self):
        ...
        # Select the AS7341 at 90 degrees by default so GAIN and ITIME work
        # immediately. RIGHT still cycles to the 180-degree reference sensor.
    ...
    def set_integration_time(self,values):
        ...
        for value, label in zip(values, labels):
            if value is not None:
                value_str = value.integration_time_str
    ...
    def update(self, measurement, battery_monitor): 
        ...
        self.set_gain((
            measurement.sensor_90,
            measurement.sensor_180,
            ))
